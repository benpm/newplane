...
class ApiTokenEndpoint(BaseAPIView):
    ...
    def get(self, request: Request, pk: Optional[str] = None) -> Response:
        if pk is None:
            ...
            # Service tokens belong to a workspace integration, not to the
            # person; the list and delete paths already hide them, so retrieve
            # and patch must too or they stay readable and renameable here.
