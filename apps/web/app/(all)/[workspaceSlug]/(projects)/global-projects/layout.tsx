...
import { GlobalProjectsSearch } from "@/plane-web/components/global-projects/search";
import { GlobalWorkspaceSelect } from "@/plane-web/components/global-projects/workspace-select";

export default function GlobalProjectsLayout() {
          ...
          <Header>
            <Header.LeftItem>
              <Breadcrumbs>
                <Breadcrumbs.Item
                  component={
                    <BreadcrumbLink label="Global Projects" icon={<Globe className="h-4 w-4 text-tertiary" />} />
                  }
                />
              </Breadcrumbs>
            </Header.LeftItem>
            <Header.RightItem>
              <GlobalProjectsSearch searchQuery={searchQuery} onChange={(q) => updateParam("search", q)} />
              {/* Date range filter */}
              <div className="hidden items-center gap-2 md:flex">
                <GlobalWorkspaceSelect
