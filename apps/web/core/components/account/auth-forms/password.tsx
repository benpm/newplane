...
export const AuthPasswordForm = observer(function AuthPasswordForm(props: Props) {
  ...
  const handlePasswordFormSubmit = async (event: FormEvent<HTMLFormElement>) => {
  ...
  return (
    <>
      ...
      <form
        ...
        onSubmit={(event) => void handlePasswordFormSubmit(event)}
      >
        ...
        <div className="space-y-1">
          ...
          <div className="relative flex items-center rounded-md bg-surface-1">
            <Input
              ...
              autoComplete="off"
              // eslint-disable-next-line jsx-a11y/no-autofocus -- password step exists solely to take this input
              autoFocus
            />
            <button
              type="button"
