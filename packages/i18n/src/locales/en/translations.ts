...
export default {
  ...
  global_projects: {
    sidebar_label: "Global Projects",
    title: "Global Projects",
    empty_state: "No global projects found.",
  },
  global_project: {
    label: "Global Project",
    settings: {
      title: "Global Project",
      label: "Mark as Global Project",
      description:
        "Designate this project as a global project, making it visible and relevant to all members across the organization.",
      header_description: "Configure Global Project settings for this project.",
      updated_success: "Global project setting has been updated.",
      updated_error: "Failed to update global project setting. Please try again.",
    },
    filter: {
      label: "Global only",
    },
  ...
  instance_dashboard: {
    ...
    subtitle: "Service health, storage and inventory for this deployment",
    refresh: "Refresh",
    panel_error: "Could not load this panel.",
    access_denied: {
      title: "Instance admins only",
      description:
        "The instance dashboard reports on the whole deployment, so it is limited to instance administrators.",
    },
    tab: {
      health: "Health",
      overview: "Overview",
    ...
    health: {
      ...
      backend: "Backend",
      bucket: "Bucket",
      enabled_tasks: "Enabled tasks",
      last_beat: "Last run",
      overdue_tasks: "Overdue",
      workers: {
        title: "Workers",
        subtitle: "Live Celery workers and broker queues",
        name: "Worker",
        pool: "Pool",
        active: "Active",
        none: "No workers responded.",
        queues: "Queues",
        queue_depth: "{messages} queued · {consumers} consumers",
      },
      jobs: {
        title: "Scheduled jobs",
        subtitle: "Periodic tasks and when they last ran",
        name: "Job",
        schedule: "Schedule",
        last_run: "Last run",
        runs: "Runs",
        none: "No scheduled jobs are configured.",
        never: "Never",
        ago: "{duration} ago",
        disabled: "Disabled",
        overdue: "Overdue",
    ...
    runtime: {
      ...
      django: "Django",
      smtp: "SMTP",
      smtp_unconfigured: "Not configured",
      debug_on: "Debug mode on",
    },
    counts: {
      workspaces: "Workspaces",
      users: "Users",
      users_active: "{count} active",
      projects: "Projects",
      projects_global: "{count} global",
      work_items: "Work items",
      created_last_7d: "{count} in last 7 days",
      cycles: "Cycles",
      modules: "Modules",
      pages: "Pages",
      comments: "Comments",
    ...
    overview: {
      instance: "Instance",
      state_distribution: "Work items by state",
      state_group: "State group",
      no_work_items: "No work items yet.",
      auth_providers: "Sign-in methods",
      no_auth_providers: "No sign-in methods are enabled.",
    },
    state_group: {
      backlog: "Backlog",
      unstarted: "Unstarted",
    ...
    storage: {
      postgres: "Database",
      postgres_subtitle: "{size} total, largest tables first",
      table: "Table",
      total: "Total",
      indexes: "Indexes",
      rows_estimate: "Rows (est.)",
      megabytes: "MB",
      object_storage: "File storage",
      object_storage_subtitle: "Measured, declared and scanned totals are reported separately",
      scanned: "Scanned",
      measured: "Measured",
      declared: "Declared",
      reclaimable: "Reclaimable",
      declared_hint: "Sizes reported by the uploader",
      reclaimable_hint: "{deleted} deleted, {pending} never uploaded",
      coverage: "{percent}% of assets measured",
      objects: "{count} objects",
      never_scanned: "No scan has been run",
      no_assets: "No files stored yet.",
      stale: "Stale",
      partial: "Partial",
      run_scan: "Scan bucket",
      scan_complete: "Bucket scan finished",
      scan_failed: "Bucket scan failed",
      unreconciled: "{bytes} in the bucket is not accounted for by measured assets.",
      by_entity_type: "By type",
      by_workspace: "By workspace",
      by_workspace_subtitle: "Best-effort totals, measured where available",
    },
    users: {
      rename_action: "Rename",
      rename_title: "Rename this account",
      rename_description: "Changes the name shown across the app. The sign-in address ({email}) is unchanged.",
      display_name: "Display name",
      ...
      deactivate_title: "Deactivate this account",
      deactivate_description: "{name} will not be able to sign in, and will be removed from workspace member lists.",
      deactivate_note:
        "Everything they created stays exactly where it is. You can reactivate the account at any time from this list.",
      reactivate_title: "Reactivate this account",
      reactivate_description: "{name} will be able to sign in again, and their workspace memberships are restored.",
      deactivated: "Account deactivated",
      reactivated: "Account reactivated",
      change_failed: "Could not change the account",
    },
    invites: {
      new: "Invite someone",
      new_description: "Creates a link you send yourself. No email is sent from this instance.",
      email: "Email",
      display_name: "Name",
      display_name_placeholder: "Optional",
      workspace: "Workspace",
      ...
      link_ready: "The link has been copied to your clipboard.",
      create_failed: "Could not create the invite",
      none: "No invites are outstanding.",
      invitee: "Invitee",
      actions: "Actions",
      copy_link: "Copy invite link",
      copied: "Invite link copied",
      copy_failed: "Could not copy automatically — here is the link",
      revoke: "Revoke invite",
      revoked: "Invite revoked",
      revoke_failed: "Could not revoke the invite",
    },
    listings: {
      tab: {
        workspaces: "Workspaces",
  ...
  staff: {
    ...
    staff_id: { label: "Staff ID", placeholder: "Staff ID (e.g. 10000001)" },
  ...
  ho: {
    ...
    export_queued: "Please download the report from the Export tab, or check your email.",
